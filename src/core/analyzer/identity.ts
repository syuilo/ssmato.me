...
import removeWhiteSpaces from './string-utilities/remove-white-spaces';
import hankakukatakanaToZenkakukatakana from './string-utilities/hankakukatakana-to-zenkakukatakana';
import katakanaToHiragana from './string-utilities/katakana-to-hiragana';
